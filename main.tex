...
%with \ttitle
\supervisor{Prof. \textsc{Jianying Zhou} and \textsc{Flavio Toffalini}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\dedicatory{This thesis is dedicated to my family} 
