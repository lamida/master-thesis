...
\thesistitle{Scalable Runtime Remote Attestation Offline Program Analysis using LLVM} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
