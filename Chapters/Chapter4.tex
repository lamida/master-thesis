...
model~\cite{toffaliniScaRRScalableRuntime2019} which we also elaborate in the
Section~\ref{sec:scarr-model}. Figure~\ref{fig:scarr-overview} shows the step on
...
result of flattened graph is in the right side of
figure~\ref{fig:simple-loop-cfg}
