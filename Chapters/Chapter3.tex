...
\ft{specify what you are going to discuss. For instance.}
...
attestation~\ft{ref} to detect attacks. The chapter ends with an overview of 
LLVM that relevant to the research~\ft{ref}. 
\ft{btw, be careful of plurals}
