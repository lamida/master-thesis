...
In the Section~\ref{sec:running-the-pass}, we shows how to run the pass.
...
We can see the output of the basic block that has been marked with checkpoint 
using
...
%We discuss the result and its interpretation in the next sec.
